...
<body class="nav-fixed" style="font-family: 'Montserrat', sans-serif !important">
    <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
        <a class="navbar-brand d-none d-sm-block" href="/"><i class="fas fa-handshake text-dark mr-3"></i><b>WIN!</b>
            Happy</a>
        ...
        <ul class="navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown no-caret mr-3 dropdown-user">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
                    ...
                    aria-expanded="false"><img class="img-fluid" src="https://picsum.photos/200/300" /></a>
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    ...
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse"
                            data-target="#collapseDashboards2" aria-expanded="false" aria-controls="collapseDashboards">
                            <div class="nav-link-icon"><i data-feather="activity"></i></div>
                            Administrativo
                            <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
        ...
        <div class="collapse" id="collapsePages" data-parent="#accordionSidenav">
            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                ...
                <a class="nav-link collapsed" href="javascript:void(0);" data-toggle="collapse"
                    ...
                    <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                <div class="collapse" id="pagesCollapseError" data-parent="#accordionSidenavPagesMenu">
                    <nav class="sidenav-menu-nested nav"><a class="nav-link" href="401.html">401 Page</a><a
                            class="nav-link" href="404.html">404 Page</a><a class="nav-link" href="404-glitch.html">404
                            Page (Glitch
    ...
    <div class="sidenav-footer">
        <div class="sidenav-footer-content">
            ...
            <div class="sidenav-footer-title">
                <a href="https://wa.me/558799220895" target="_blank" class="text-dark">(87) 9 99220895 </a>
            </div>
            <div class="sidenav-footer-title">
                <a href="https://wa.me/557182565951" target="_blank" class="text-dark">(71) 9 8256-5951</a>
            </div>
        </div>
    </div>
    <div class="sidenav-footer">
