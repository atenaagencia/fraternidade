        ...
        <div class="page-header-content row">
            ...
            <div class="col-lg-2 mx-auto">
                <div class="bd-example">
                    <p class="lead text-light font-weight-bold">Fila 1 | Progresso Atual:</p>
            ...
            <div class="col-md-4">
                <div class="card border-0 mb-4">
                    ...
                    <div class="card-body bg-user-info">
                        ...
                        <div class="btn btn-light col-8 offset-2 py-3 mt-4 btn-block font-weight-bold">Mais Detalhes</div>
                    </div>
                </div>
            </div>
        </div><!--col--12-->
